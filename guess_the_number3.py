...
def index():
    if request.method == 'GET':
        ...
        if request.form["answer"] == "To small" or request.form["answer"] == "To big":
            ...
            return render_template('guess_the_number3_game.html', guess=guess, min_number=min_number, max_number=max_number)
        else:
